...
#[contract]
pub struct OfwInsurancePremiumCollectorContract;

#[contractimpl]
impl OfwInsurancePremiumCollectorContract {
    ...
    pub fn record_remittance_record(env: Env, id: String, actor: Address, amount: i128, score: u32) -> Result<(), Error> {
        if amount <= 0 {
            return Err(Error::InvalidAmount);
        }
